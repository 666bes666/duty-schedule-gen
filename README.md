...
| `always_on_duty` | Постоянное дежурство (только Москва, требует morning_only или evening_only) | `false` |
...
| `optimization_priority` | Приоритет оптимизации: `isolated_weekends`, `evening_shifts`, `consecutive_days`, `weekend_days` | — |
